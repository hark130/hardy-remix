...
#include "HARE_memwatch.h"  // initMemwatch(), termMemwatch()

#define LOGGING 0  // 1 for on
#define BINARY_NAME "source06_bad"
...
int main(int argc, char *argv[])
{
    ...
    // DO IT
    initMemwatch();  // Conditionally initialize Memwatch
    ...
    LOG_IT("\n");  // AFL DEBUGGING
    termMemwatch();  // Conditionally terminate Memwatch
    return success;
}
